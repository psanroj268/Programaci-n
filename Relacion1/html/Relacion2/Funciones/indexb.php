...
<body>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col d-flex justify-content-end">
                    <a href="./formulario.php"><button class="btn btn-primary">Añadir Libro</button></a>
                </div>
            </div>
    ...
    <?php
        echo (!$p) ? "atrás" : "<a href=\"indexb.php?pagina=" .($p-1). "\">atras</a>";
        echo "&nbsp;|&nbsp;" ;
        echo (!$p) ? "0" : "<a href=\"indexb.php?pagina=" .($p = 0). "\">0</a>";
        echo "&nbsp;|&nbsp;" ;
        echo ($p == $total) ? "1" : "<a href=\"indexb.php?pagina=" .($p = 1). "\">1</a>";
        echo "&nbsp;|&nbsp;" ;
        echo ($p == $total) ? "2" : "<a href=\"indexb.php?pagina=" .($p = 2). "\">2</a>";
        echo "&nbsp;|&nbsp;" ;
        echo ($p == $total) ? "siguiente" : "<a href=\"indexb.php?pagina=" .($p+1). "\">siguiente</a>";
